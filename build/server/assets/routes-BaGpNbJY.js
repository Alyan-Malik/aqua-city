...
import { n as SectionTitle, t as FeatureCard } from "./FeatureCard-PIo6TXXD.js";
		...
		children: /* @__PURE__ */ jsxs(Link, {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", {
						className: "mt-1 text-[11px] sm:text-xs text-muted-foreground line-clamp-2",
						children: description
					}),
					/* @__PURE__ */ jsxs("div", {
						className: "mt-2.5 inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-semibold text-brand",
						children: ["Explore", /* @__PURE__ */ jsx(FiArrowRight, { className: "h-3 w-3 transition-transform group-hover:translate-x-1" })]
					})
				]
			})]
		})
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(SectionTitle, {
					...
					children: transformedCategories.length > 0 ? transformedCategories.map((cat, i) => /* @__PURE__ */ jsx(CategoryCard, {
						...
						className: "card-surface p-3 animate-pulse",
						children: [
							/* @__PURE__ */ jsx("div", { className: "aspect-[16/10] bg-muted rounded-lg" }),
							/* @__PURE__ */ jsx("div", { className: "h-4 bg-muted rounded mt-3" }),
							/* @__PURE__ */ jsx("div", { className: "h-3 bg-muted rounded mt-2" })
						]
					}, i))
				})]
			})
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: featured.length > 0 ? featured.map((product, i) => /* @__PURE__ */ jsx(ProductCard, {
							product,
							index: i
						}, product.id)) : Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
							className: "card-surface p-3 animate-pulse",
							children: [
								/* @__PURE__ */ jsx("div", { className: "aspect-[16/10] bg-muted rounded-lg" }),
								/* @__PURE__ */ jsx("div", { className: "h-4 bg-muted rounded mt-3" }),
								/* @__PURE__ */ jsx("div", { className: "h-3 bg-muted rounded mt-2 w-2/3" }),
								/* @__PURE__ */ jsx("div", { className: "h-3 bg-muted rounded mt-2 w-1/2" })
							]
						}, i))
					}),
					/* @__PURE__ */ jsx("div", {
