...
import { FiArrowUp, FiChevronDown, FiClock, FiMail, FiMapPin, FiMenu, FiPhone, FiX } from "react-icons/fi";
import { BsWhatsapp } from "react-icons/bs";
import { AnimatePresence, motion } from "framer-motion";
import { Toaster } from "sonner";
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaWhatsapp } from "react-icons/fa";
//#region src/styles.css?url
var styles_default = "/assets/styles-D75XD5L9.css";
//#endregion
...
function Navbar() {
	...
	return /* @__PURE__ */ jsxs("header", {
		className: "fixed inset-x-0 top-0 z-50 bg-white/95 backdrop-blur-md shadow-[0_4px_24px_-8px_rgba(9,36,96,0.18)] transition-all duration-300",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "bg-brand text-white",
				children: /* @__PURE__ */ jsxs("div", {
					className: "container-x flex items-center justify-between gap-4 py-1.5 text-[11px] sm:text-xs",
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "hidden md:flex items-center gap-5 text-white/80",
							children: [
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5",
									children: [/* @__PURE__ */ jsx(FiMapPin, { className: "h-3 w-3 text-cyan-300" }), "K-25 Main Murree Road, Rawalpindi"]
								}),
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5",
									children: [/* @__PURE__ */ jsx(FiClock, { className: "h-3 w-3 text-cyan-300" }), "Mon – Sat: 9:00 AM – 8:00 PM"]
								}),
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5",
									children: [/* @__PURE__ */ jsx(FiMail, { className: "h-3 w-3 text-cyan-300" }), "aquacityrwp1@gmail.com"]
								})
							]
						}),
						/* @__PURE__ */ jsxs("span", {
							className: "md:hidden inline-flex items-center gap-1.5 text-white/80",
							children: [/* @__PURE__ */ jsx(FiMapPin, { className: "h-3 w-3 text-cyan-300" }), "Main Murree Road, Rawalpindi"]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-4 text-white/80",
							children: [/* @__PURE__ */ jsx("span", {
								className: "hidden sm:inline",
								children: "Free installation on all systems"
							}), /* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(FiPhone, { className: "h-3 w-3" }), "0334 0503503"]
							})]
						})
					]
				})
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("nav", {
						...
						children: [
							NAV_LINKS.filter((l) => l.to !== "/products").map((l) => /* @__PURE__ */ jsx(Link, {
								to: l.to,
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsx(motion.div, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							className: "rounded-xl bg-secondary/70 p-3 mb-1 grid gap-2 text-xs text-muted-foreground",
							children: [/* @__PURE__ */ jsxs("span", {
								className: "inline-flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(FiClock, { className: "h-3.5 w-3.5 text-brand shrink-0" }), "Mon – Sat: 9:00 AM – 8:00 PM"]
							}), /* @__PURE__ */ jsxs("a", {
								href: "mailto:aquacityrwp1@gmail.com",
								className: "inline-flex items-center gap-2 hover:text-brand transition-colors",
								children: [/* @__PURE__ */ jsx(FiMail, { className: "h-3.5 w-3.5 text-brand shrink-0" }), "aquacityrwp1@gmail.com"]
							})]
						}),
						NAV_LINKS.filter((l) => l.label !== "Products").map((l) => /* @__PURE__ */ jsx(Link, {
							to: l.to,
	...
	return /* @__PURE__ */ jsx(QueryClientProvider, {
		...
		children: typeof window !== "undefined" && (window.location.pathname.startsWith("/admin") || window.location.pathname === "/login") ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Outlet, {}), /* @__PURE__ */ jsx(Toaster, {
			...
			children: [
				/* @__PURE__ */ jsx(Navbar, {}),
				/* @__PURE__ */ jsx("main", {
					className: "flex-1 pt-[117px] sm:pt-[126px] lg:pt-[134px]",
...
var $$splitComponentImporter$8 = () => import("./routes-BGQjukBH.js");
...
var $$splitComponentImporter$7 = () => import("./about-B0Xkz5nU.js");
...
var $$splitComponentImporter$2 = () => import("./admin.dashboard-CFBXzqh8.js");
...
var $$splitComponentImporter$1 = () => import("./admin.products-UKNarHD_.js");
